...
use MarafyBundle\Entity\Categorie;
use MarafyBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('MarafyBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MarafyBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('MarafyBundle\Form\CategorieType', $categorie);
